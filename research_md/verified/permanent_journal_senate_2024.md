# Research Draft: permanent_journal_senate_2024

- Source JSON: `permanent_journal_senate_2024.json`
- Keyword hits: **star bond, tax revenue, sales tax, income tax, budget, appropriation**
...
```json
{
  ...
  "title": "SB 381, SB 420, SB 430, SB 431",
  "jurisdiction": "Kansas",
  "locations": [
    "Topeka",
    "Kansas",
    ...
    "Manhattan",
    "Neosho county",
    "north central Kansas technical college area",
    "northwest Kansas technical college area",
    "Pratt",
    "Salina area",
    "Seward county",
    ...
    "Larned state correctional facility \u2013 general fees fund (408-00-2145-2000)",
  ...
  "entities": [
    ...
    {
      "name": "Senator Ty Masterson",
      "type": "PERSON"
    },
    {
      "name": "Reverend Cecil T. Washington",
      "type": "PERSON"
    },
    {
      "name": "Senator Holland",
      "type": "PERSON"
    },
    {
      "name": "Senator Kerschen",
      "type": "PERSON"
    },
    {
      "name": "Senator Olson",
    ...
    {
      "name": "the Legislature of the State of Kansas",
      "type": "GOV_BODY"
    },
    {
      "name": "Ty Masterson",
...
Search query:
`Research Draft permanent_journal_senate_2024 site:ks.gov site:kansas.gov`

Search link:
https://duckduckgo.com/?q=Research+Draft+permanent_journal_senate_2024+site%3Aks.gov+site%3Akansas.gov

...
- Facts file: `facts/legislative_deadlines.json`

## Entities

- {'name': 'Susan W. Kannarr', 'type': 'PERSON'}
- {'name': 'Corey Carnahan', 'type': 'PERSON'}

## Evidence (quotes)

> The following dates are the deadlines for introduction and consideration of bills for the 2026 session.
